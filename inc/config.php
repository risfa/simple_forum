...
$config['database']['database'] = 'dapps_mnc';
$config['database']['table_prefix'] = 'mybb_mnc';

$config['database']['hostname'] = 'localhost';
$config['database']['username'] = 'dapps';
$config['database']['password'] = 'admin5D';
